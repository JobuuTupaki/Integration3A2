...
<template>
    <div>
      <AuthenticatedLayout>
        <template #header>
          <Head title="Speed-Up" />
          <h2 class="font-bold text-3xl text-gray-800 dark:text-gray-200 leading-tight mb-1">Dashboard</h2>
        </template>
...
<div>
  ...
  <dl class="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
      <dt>
        ...
        <p class="ml-16 truncate text-sm font-medium text-gray-300">Total Transactions</p>
      </dt>
    ...
    <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
      <dt>
        ...
        <p class="ml-16 truncate text-sm font-medium text-gray-300">Total Expenses</p>
      </dt>
      <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
    ...
    <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
      <dt>
        ...
        <p class="ml-16 truncate text-sm font-medium text-gray-300">Reports</p>
      </dt>
      <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
